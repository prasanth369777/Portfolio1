  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Shifting Blobs - Hidden/Reduced on Mobile for performance */}
        <motion.div 
            animate={{ scale: [1, 1.1, 1], x: [0, 50, 0], y: [0, -30, 0] }}
            transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
            className="absolute -top-[10%] -left-[10%] w-[80%] md:w-[50%] h-[50%] bg-[radial-gradient(circle,_rgba(129,140,248,0.06)_0%,_transparent_70%)] blur-[80px] md:blur-[100px]" 
        />
        <motion.div 
            animate={{ scale: [1, 1.2, 1], x: [0, -40, 0], y: [0, 50, 0] }}
            transition={{ duration: 18, repeat: Infinity, ease: "easeInOut", delay: 2 }}
            className="absolute -bottom-[15%] -right-[5%] w-[70%] md:w-[45%] h-[45%] bg-[radial-gradient(circle,_rgba(244,114,182,0.06)_0%,_transparent_70%)] blur-[100px] md:blur-[120px]" 
        />

        {/* Blueprint Grid - Responsive background size */}
        <div 
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 lg:px-12 w-full flex-grow flex flex-col justify-center">
        {/* --- TOP ROW --- */}
        <div className="flex justify-between items-start mb-8 md:mb-12 border-b border-zinc-200 pb-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] md:text-xs font-mono text-zinc-500 uppercase tracking-[0.2em] md:tracking-[0.3em] font-bold">Collaborative Intelligence</span>
          </div>
          <div className="hidden sm:flex flex-col text-right text-[10px] md:text-xs font-mono text-blue-500 uppercase tracking-[0.2em] font-bold">
            <span>Based In</span>
        ...
        {/* --- MAIN CONTENT --- */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-0 items-center py-10">
          
          {/* LEFT CONTENT */}
          <div className="lg:col-span-7 flex flex-col justify-center lg:pr-16 text-left order-2 lg:order-1">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
            >
              <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[11rem] font-serif font-light leading-[0.9] lg:leading-[0.85] tracking-tighter mb-6 md:mb-10 text-zinc-900">
                Visual <br />
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-zinc-500 max-w-xl leading-relaxed font-light mb-8 md:mb-12">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 md:gap-10">
                <button
                  ...
                  className="w-full sm:w-auto group relative overflow-hidden px-8 md:px-12 py-4 md:py-6 bg-zinc-900 text-white text-[10px] md:text-[11px] font-bold uppercase tracking-[0.4em] rounded-sm transition-all shadow-xl"
                >
                ...
                <div className="flex flex-col border-l border-zinc-200 pl-6 md:pl-8">
                    <span className="text-[10px] text-zinc-400 uppercase tracking-widest mb-1 font-bold">Expertise In</span>
                    <span className="text-sm md:text-base text-zinc-800 font-medium font-mono tracking-tighter uppercase"> UI Systems / Research / Figma</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center order-1 lg:order-2">
            ...
            {/* CIRCULAR TEXT BADGE - Responsive Sizing */}
            <motion.div 
              style={{ rotate }}
              className="absolute -top-5 -right-5 md:-top-10 md:-right-10 z-20 pointer-events-none"
            >
              <svg viewBox="0 0 200 200" className="w-32 h-32 sm:w-48 h-48 md:w-72 md:h-72">
                <path id="circlePath" d="M 100, 100 m -80, 0 a 80,80 0 1,1 160,0 a 80,80 0 1,1 -160,0" fill="none" />
                <text className="text-[10px] md:text-[12px] font-mono uppercase tracking-[0.5em] font-bold">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-[300px] sm:max-w-[380px] md:max-w-[430px] aspect-[3/4] p-[1.5px] group overflow-hidden shadow-2xl shadow-indigo-100/30 bg-gradient-to-br from-indigo-300 via-pink-200 to-emerald-300"
            >
              ...
              <div className="absolute bottom-8 md:bottom-12 left-[-10px] md:left-[-15px] bg-zinc-900 text-white px-4 md:px-8 py-2 md:py-4 text-[9px] md:text-[11px] font-bold font-mono uppercase tracking-[0.4em] rotate-[-90deg] origin-left shadow-2xl">
        ...
        <div className="mt-auto py-8 md:py-12 border-t border-zinc-200">
           <div className="flex flex-col md:flex-row justify-between items-center gap-8">
             <div className="flex flex-wrap justify-center md:justify-start gap-x-8 md:gap-x-16 gap-y-4 group">
               {['SYSTEM DESIGN', 'UI ARCHITECTURE', 'FIGMA', 'REACT' , "TAILWIND"].map((skill, i) => (
                 <div key={i} className="flex items-center gap-3">
                   ...
                   <span className="text-[9px] md:text-[11px] font-mono text-zinc-400 uppercase tracking-[0.4em] group-hover:text-zinc-900 transition-colors font-bold whitespace-nowrap">
                     {skill}
                   </span>
                 </div>
               ))}
             ...
             <a 
              ...
              className="group text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-zinc-900 transition-colors flex items-center gap-4"
             >
               Direct Inquiry 
               <span className="relative w-10 h-[1.5px] overflow-hidden">
                  <span className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-pink-400 to-emerald-500 translate-x-[-100%] group-hover:translate-x-[0%] transition-transform duration-500" />
