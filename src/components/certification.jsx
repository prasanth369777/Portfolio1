...
const CertificationRoadmap = () => {
  return (
    <section id="certification" className="relative py-32 bg-[#080808] overflow-hidden font-sans selection:bg-white selection:text-black">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        {/* --- LIST LAYOUT --- */}
        {/* 'group/list' enables the sibling-dimming effect */}
        <div className="group/list flex flex-col border-t border-white/10">
           ...
           {certifications.map((cert, idx) => (
             <div 
               key={idx}
               className="
                 group flex flex-col md:flex-row items-start md:items-center py-8 border-b border-white/10 
